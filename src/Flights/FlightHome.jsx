...
import styles from "../CSS/flight.module.css";
              ...
              <div className={styles.from}>
                <FormControl sx= {{ width: "100%" }}>
                  ...
                  <Select
                    ...
                    value={from}
                    label="from"
                    onChange={(e) => {localStorage.setItem("fromFlight", e.target.value); setFrom(e.target.value);}}
                  >
              ...
              <div className={styles.to}>
                <FormControl  sx={{  width: "100%" }}>
                  ...
                  <Select
                    ...
                    value={to}
                    label="to"
                    onChange={(e) => {localStorage.setItem("toFlight", e.target.value); setTo(e.target.value)}}
                  >
                    <MenuItem value={"Bengaluru"}>Bengaluru</MenuItem>
                    <MenuItem value={"Mumbai"}>Mumbai</MenuItem>
                    <MenuItem value={"Pune"}>Pune</MenuItem>
