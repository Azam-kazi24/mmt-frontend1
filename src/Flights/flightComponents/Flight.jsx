...
export const Flight = () => {
  ...
  const getFlight = () => {
    ...
    const toFlight = localStorage.getItem("toFlight");
    const fromFlight = localStorage.getItem("fromFlight");
    console.log("toFlight", toFlight, "fromFlight", fromFlight);
    dispatch(flightLoading());
    fetch("https://mmt-json-server.vercel.app/flights")
    // fetch("mongodb://localhost:27017/Flights/")
      .then((r) => r.json())
      .then((r) => {
        dispatch(addFlights(r));
        const tempFlight = r;
        console.log(tempFlight);
        const temp1 = tempFlight.filter((el) => el.departure === fromFlight && el.arrival === toFlight);
          ...
          <div className={styles.box}>
            ...
            <div className={styles.container}>
              <div className={styles.heading}>
                <h3>{flights && <>{`Flights from ${localStorage.getItem("fromFlight")} to ${localStorage.getItem("toFlight")}`}</>}</h3>
              </div>
